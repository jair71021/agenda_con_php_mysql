$(document).ready(function(){
	$('#cargaTablaContactos').load('vistas/contactos/tabla_contactos.php');
	...
	$('#btnAgregarContacto').click(function(){
		...
		if ($('#idCategoriaSelect').val() == 0) {
			...
			swal("Debes agregar el apellido paterno ");
			return false;
		}else if ($('#materno').val() == "") {
			swal("Debes agregar el apellido materno");
		}else if ($('#telefono').val() == "") {
			swal("Debes agregarun numero telfonico ");
			return false;
		}else if ($('#email').val() == "") {
